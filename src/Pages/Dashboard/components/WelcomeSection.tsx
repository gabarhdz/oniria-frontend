...
export const WelcomeSection: React.FC<WelcomeSectionProps> = ({ user }) => {
  ...
  return (
    <div 
      ...
      className="relative text-center space-y-8 py-12"
      style={{
    ...
    >
      ...
      <div 
        ...
        style={{
          background: `radial-gradient(600px circle at ${mousePosition.x}% ${mousePosition.y}%, rgba(150, 117, 188, 0.08), transparent 60%)`,
        }}
      />
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        {/* Main dream bubbles */}
        <div 
          className="absolute animate-dream-bubble opacity-6"
          style={{
            top: '15%',
            left: '10%',
            width: '120px',
      ...
      <div className={`relative z-10 space-y-8 transform transition-all duration-1000 ${
        ...
        <div className="relative inline-flex items-center justify-center">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-[#9675bc] via-[#f1b3be] to-[#ffe0db] rounded-full blur-3xl opacity-15 animate-pulse w-40 h-40 scale-110" />
          <div className="absolute inset-0 bg-gradient-to-r from-[#f1b3be] to-[#9675bc] rounded-full blur-2xl opacity-20 animate-pulse w-32 h-32" style={{ animationDelay: '1s' }} />
          
          {/* Orbiting elements */}
          <div className="absolute inset-0 w-40 h-40 animate-spin-slow">
            <div className="absolute top-0 left-1/2 w-2 h-2 bg-[#ffe0db] rounded-full transform -translate-x-1/2 animate-pulse" />
            <div className="absolute bottom-0 left-1/2 w-1.5 h-1.5 bg-[#f1b3be] rounded-full transform -translate-x-1/2 animate-pulse" style={{ animationDelay: '0.5s' }} />
            <div className="absolute left-0 top-1/2 w-1 h-1 bg-[#9675bc] rounded-full transform -translate-y-1/2 animate-pulse" style={{ animationDelay: '1s' }} />
            <div className="absolute right-0 top-1/2 w-1.5 h-1.5 bg-[#ffe0db] rounded-full transform -translate-y-1/2 animate-pulse" style={{ animationDelay: '1.5s' }} />
          </div>
          
          {/* Main avatar container */}
          <div 
            ref={avatarRef}
            className="relative group transform transition-all duration-700 hover:scale-110 hover:rotate-3"
          >
            {/* Avatar glow effect */}
            ...
            {/* Avatar content */}
            <div className="relative w-28 h-28 rounded-full overflow-hidden shadow-2xl group-hover:shadow-3xl transition-shadow duration-500">
        ...
        <div className={`space-y-6 transform transition-all duration-700 ${
          ...
          {/* Main greeting with advanced effects */}
          <div className="relative">
            <h1 
              className="text-5xl font-bold bg-gradient-to-r from-[#ffe0db] via-[#f1b3be] to-[#9675bc] bg-clip-text text-transparent hover:bg-gradient-to-l transition-all duration-700 hover:scale-105 cursor-default"
            ...
            <div className="absolute -bottom-2 left-1/2 transform -translate-x-1/2 w-0 h-0.5 bg-gradient-to-r from-transparent via-[#f1b3be] to-transparent group-hover:w-32 transition-all duration-1000" />
          </div>
          ...
          <div className={`flex items-center justify-center space-x-3 text-[#ffe0db]/90 transform transition-all duration-700 ${
            ...
            {user.is_psychologist ? (
              <>
                ...
                <div className="flex items-center space-x-2 bg-gradient-to-r from-yellow-400/10 to-amber-500/10 px-4 py-2 rounded-full border border-yellow-400/20 backdrop-blur-sm hover:border-yellow-400/40 transition-all duration-300 group">
                  <Shield className="w-4 h-4 text-yellow-400 group-hover:rotate-12 transition-transform duration-300" />
                ...
                <div className="relative group">
                  <Crown className="w-6 h-6 text-yellow-400 group-hover:text-yellow-300 transition-colors duration-300 animate-bounce" style={{ animationDelay: '0.2s' }} />
                  <div className="absolute inset-0 bg-yellow-400/20 rounded-full blur-sm opacity-0 group-hover:opacity-100 transition-opacity duration-300 scale-150" />
                </div>
              </>
            ) : (
