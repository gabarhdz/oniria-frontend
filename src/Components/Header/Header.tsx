...
const Header = () => {
  ...
  return (
        ...
        <div className='absolute top-16 left-0 w-full bg-oniria_blue z-50 shadow-lg'>
            <div className='p-6 border-t border-oniria_lightpink/20'>
                <ul className='space-y-6 text-center'>
                    <li>
                        <Link to={'/'} className='text-2xl text-oniria_lightpink hover:text-oniria_darkblue transition-colors duration-300 block py-2'>Chatbot</Link>
                    </li>
                    <li>
                        <Link to={'/'} className='text-2xl text-oniria_lightpink hover:text-oniria_darkblue transition-colors duration-300 block py-2'>Análisis</Link>
                    </li>
                    <li>
                        <Link to={'/'} className='text-2xl text-oniria_lightpink hover:text-oniria_darkblue transition-colors duration-300 block py-2' >Psicólogos</Link>
                    </li>
                    <li>
                        <Link to={'/'}className='text-2xl text-oniria_lightpink hover:text-oniria_darkblue transition-colors duration-300 block py-2'> Comunidad </Link>
                    </li>
                    <li className='pt-6 border-t border-oniria_lightpink/20'>
                        <div className='flex justify-center gap-4 mt-4'>
                            <Link to={'/signup'} className='px-6 py-2 rounded-full border-2 border-oniria_darkblue bg-oniria_lightpink text-oniria_blue hover:bg-oniria_darkblue hover:text-oniria_lightpink transition-colors duration-300'> Sign Up </Link>
                            <Link to={'/login'} className='px-6 py-2 rounded-full border-2 border-oniria_lightpink text-oniria_lightpink hover:bg-oniria_lightpink hover:text-oniria_blue transition-colors duration-300'> Log In </Link>
                        </div>
                    </li>
                </ul>
            </div>
    ...
    {/* Versión escritorio - Visible solo en md hacia arriba */}
